...
The employee request validates:
...
Returned when the updated email conflicts with an existing employee.
...
The deposit amount must satisfy the application's configured business rules.
...
Relevant Jira ticket IDs should be recorded in docs/JIRA_LINKS.md.
